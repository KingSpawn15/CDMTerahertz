function [tc, xc, field_laser_profile] = rectification_meep(spot_size_fwhm)
    load('article_check/saved_matrices_meep/set1/field_ez100.0_fs.mat')
...
%     imagesc(e_or_0.')
    ...
    field_laser_profile = convolve_laser_profile(e_or_90, xc, spot_size_fwhm);
%     
%     close all
