clearvars;
dir = 'results/optimization_results/pd/';
[~ , ~ , ~] = mkdir(dir);
load('saved_matrices/v_struct_45.mat');
load('results/optimization/results_pd/optimization_results_pd.mat');
...
list_delay = [optimization_combined(1:nplots).delay_pd];
...
for ii = 1:nplots
    ...
    interaction_gain_factor_rectification = 0;
