...
params_rectification.tau = 21e-15;
params_rectification.lambda = 800e-9;
params_rectification.d  = .5e-3;
params_rectification.sigma_z = 50e-6 / 1.5;
params_rectification.z = -1e-6;
E_max_rectification = -(1.631e6) * 1.65 / 40 * 1.2;
delay_or_pd_ps = 0.1;
...
exportgraphics(gcf, 'ShorterPulseResults/power_fig_errors_all.png', 'Resolution',300);
