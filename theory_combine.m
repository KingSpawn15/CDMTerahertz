% measurement_plots.plot_measurement('saved_matrices/rectification.mat', 56);
...
% laser parameters
pulse_energy_experiment = 0.1 * 1e-9;
pulse_energy_gain_factor = 1;
% theta_pol_degree = 90;
...
for theta_pol_degree = [0 : 5 : 90]
    ...
    str = ['results/','eels_angle=',num2str(theta_pol_degree),'_method=',method];
