...
if nargout == 2
    try
        ...
        switch dim
            case 1
            image = tags.ImageList.Unnamed1.ImageData.Data.Value';
            case 2
            %image
            image = reshape(tags.ImageList.Unnamed1.ImageData.Data.Value,...
                            tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed0.Value,...
                            tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed1.Value)';
            otherwise
            %3D image, e.g. EELS map
            image = permute(reshape(tags.ImageList.Unnamed1.ImageData.Data.Value,...
                                    tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed0.Value,...
                                    tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed1.Value,...
                                    tags.ImageList.Unnamed1.ImageData.Dimensions.Unnamed2.Value),[2 1 3]);
        end
    catch
...
function [dim] = getdims(tags)
% Author: Kangpeng Wang
dim = length(fieldnames(tags.ImageList.Unnamed1.ImageData.Dimensions));
